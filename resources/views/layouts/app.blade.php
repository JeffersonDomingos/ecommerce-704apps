...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('resources/css/ecommerce/responsive.css') }}">
</head>
<body>
    <div id="app">
    ...
    <script src="{{ asset('resources/js/bxslider.min.js') }}"></script>
    <script src="{{ asset('resources/js/script.slider.js') }}"></script>
</body>
</html>
